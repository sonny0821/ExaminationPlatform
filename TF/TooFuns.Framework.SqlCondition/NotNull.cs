...
{
	public class NotNull : BaseCondition
	{
		internal NotNull(string columnName) : base(columnName)
		{
		}
		public override string ToString(Command command)
		{
			return string.Format("{0}{1}{2} IS NOT NULL", command.Connection.SpecialStart, this.columnName, command.Connection.SpecialEnd);
		}
